...
```bash
corepack pnpm --parallel --filter @ai-service-desk/api-gateway --filter @ai-service-desk/auth-service --filter @ai-service-desk/rag-service --filter @ai-service-desk/chatbot-service --filter @ai-service-desk/ticket-service dev
```
